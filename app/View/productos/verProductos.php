                                ...
                                <?php foreach ($productos as $producto): ?>
                                    <div class="col-md-4">
                                        <div class="card" style="width: 18rem;">
                                            <?php if ($producto['IMAGEN']): ?>
                                                <img src="/G3_SC502_VN_Proyecto/app/View/subirImg/<?php echo basename($producto['IMAGEN']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($producto['TITULO_PUBLI']); ?>" style="object-fit: cover; width: 100%; height: 200px;">
                                            <?php endif; ?>
                                            <div class="card-body">
                                                <p class="card-text">Descripción: <?php echo htmlspecialchars($producto['DESCRIPCION']); ?></p>
                                                <p class="card-text">Telefono: <?php echo htmlspecialchars($producto['TELEFONO']); ?></p>
                                                <p class="card-text">Ubicación:
                                                    <?php
                                                    echo htmlspecialchars($producto['PROVINCIA']) . ', ' .
                                                        htmlspecialchars($producto['CANTON']) . ', ' .
                                                        htmlspecialchars($producto['DISTRITO']) . ', ' .
                                                        htmlspecialchars($producto['OTRAS_SENAS']);
                                                    ?>
                                                </p>
                                                <?php if ($_SESSION['id_rol'] == 1 || $producto['ID_USUARIO'] == $_SESSION['id_usuario']): ?>
                                                    <a href="../productos/productoActualizar.php?id_producto=<?php echo $producto['ID_PRODUCTO']; ?>" class="btn btn-primary btn-sm">Actualizar</a>
